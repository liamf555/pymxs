...
def enjoy() -> None:  # noqa: C901
    ...
    parser.add_argument("--env", help="Environment to use", type=str, default="gym_mxs/MXSBox2D-v0")
    parser.add_argument("-f", "--folder", help="Log folder", type=str, default="rl-trained-agents")
    parser.add_argument("--algo", help="Algorithm to use", type=str, default="sac")
