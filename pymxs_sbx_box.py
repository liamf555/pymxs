...
if __name__ == "__main__":
  ...
  training_args.add_argument("-s", "--steps", help="Total timesteps to train for", type=int, default=100_000)
  ...
  env = gym.make(args.env, reward_func=reward_func, timestep_limit=1000, render_mode=args.training_render_mode)
